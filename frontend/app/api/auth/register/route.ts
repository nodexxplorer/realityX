  ...
  try {
    ...
    await pool.query(
      ...
      INSERT INTO profiles
        (user_id, name, nickname, is_premium, verified, email_verified, created_at, updated_at, email)
      ...
      [
        ...
        name ?? null,
        nickname ?? null,
        2,  // ✅ NUMERIC role: 2 = user (default) - NOT "user" text!
        false,
        false,
        supaUser.confirmed_at ?? null,
        email,
      ]
    );

    // 4️⃣ Ensure subscription exists
